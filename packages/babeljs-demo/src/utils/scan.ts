...
import ora from "ora";
import { glob, readFileAsync } from "./fs";
...
export async function scanFile(file: string, scanFn: ScanFN): Promise<void> {
...
export async function scan(taskName: string, scanFn: ScanFN) {
